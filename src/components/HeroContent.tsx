...
import { HERO_SLIDES } from '@/context/home/home-data';
    ...
    <div className="relative z-10 w-full mt-[0px] md:-mt-[200px]">
      ...
      >
        <Button
          variant="default"
          size="lg"
          className="w-[110px] md:w-[130px] h-10 md:h-12 text-[16px] relative group transition-all duration-300 !bg-white !text-black hover:!bg-white/90 !border-0 !rounded-[12px]"
        ...
        <Button
          variant="outline"
          size="lg"
          className="w-[110px] md:w-[130px] h-10 md:h-12 text-[16px] relative group transition-all duration-300 !bg-transparent !text-white !border-white/10 hover:!bg-white/10 !rounded-[12px]"
